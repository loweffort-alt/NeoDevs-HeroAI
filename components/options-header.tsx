...
const OptionsHeader = () => {
  ...
  return (
    <>
      <div className="md:m-auto font-4 pt-1 md:pl-14 pl-1 h-full flex flex-wrap items-center max-md:flex-col max-md:justify-evenly md:text-base text-1xl md:justify-center justify-items-start">
        <Link href="/playground" className="md:mr-11 cursor-pointer text-gray-300 hover:text-white font-semibold tr04 max-md:text-3xl">
          Playground
        </Link>
